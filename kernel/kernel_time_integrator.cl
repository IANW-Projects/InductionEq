...
*/
kernel void calc_time_2_args(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
...
*/
kernel void calc_time_3_args(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                             global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                             global REAL *d_field_rho, global REAL *time) {
...
*/
kernel void calc_u_2_args(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                          global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                          global REAL *d_field_rho, global REAL *time) {
...
with SSPRK33.
*/
kernel void calc_u_3_args(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                          global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                          global REAL *d_field_rho, global REAL *time) {
...
*/
kernel void SSPRK33_1(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                      global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                      global REAL *d_field_rho, global REAL *time) {
  ...
  d_field_b2[idx] =
    d_field_b1[idx] + (REAL)DT * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}

kernel void SSPRK33_2(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                      global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                      global REAL *d_field_rho, global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT);

  d_field_b3[idx] =
    (REAL)(0.75) * d_field_b1[idx]
    + (REAL)(0.25) * (d_field_b2[idx] + (REAL)DT * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time));
}

kernel void SSPRK33_3(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                      global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                      global REAL *d_field_rho, global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(0.5*DT);
...
derivative.
*/
kernel void SSPRK104_01(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  d_field_b2[idx] =
    d_field_b1[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_02(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT/6.0);

  d_field_b3[idx] =
    d_field_b2[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_03(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT/3.0);

  d_field_b2[idx] =
    d_field_b3[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b3, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_04(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT/2.0);

  d_field_b3[idx] =
    d_field_b2[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_05(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT*2.0/3.0);

  d_field_b2[idx] =
    d_field_b3[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b3, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_06(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
...
kernel void SSPRK104_07(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
...
kernel void SSPRK104_08(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
...
kernel void SSPRK104_09(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
...
kernel void SSPRK104_10(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  uint idx = calc_idx(ix,iy,iz);
	...
	REAL local_time = time[0] + (REAL)(DT*5.0/6.0);

  d_field_b2[idx] =
    d_field_b1[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}
kernel void SSPRK104_11(global REAL4 *d_field_b1, global REAL4 *d_field_b2, global REAL4 *d_field_b3,
                        global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u, global REAL *d_field_rho,
                        global REAL *time) {
  ...
  d_field_b1[idx] =
    d_field_b3[idx]
    + (REAL)(0.6) * (d_field_b2[idx] + (REAL)(DT/6.0) * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time));
}
...
kernel void KennedyCarpenterLewis2R54C_1a(
  ...
  d_field_db[idx] = (REAL)(DT) * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}
...
kernel void KennedyCarpenterLewis2R54C_2a(
  ...
  REAL coef_C = (REAL)(0.22502245872571303);
	...
	REAL local_time = time[0] + coef_C * (REAL)(DT);
...
kernel void KennedyCarpenterLewis2R54C_3a(
  ...
  d_field_db[idx] = (REAL)(DT) * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time);
}
...
kernel void KennedyCarpenterLewis2R54C_5(
  ...
  d_field_b1[idx] =
    d_field_b1[idx]
    + coef_B * (REAL)(DT) * DB(ix, iy, iz, d_field_b2, d_field_curlB_rho, d_field_u, local_time);
}
...
*/
kernel void CarpenterKennedy2N54_1a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
  ...
  d_field_b2[idx] = (REAL)(DT) * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}
kernel void CarpenterKennedy2N54_1b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_2a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
  ...
  d_field_b2[idx] = coef_A * d_field_b2[idx]
                    + (REAL)(DT) * DB(ix, iy, iz, d_field_b1, d_field_curlB_rho, d_field_u, local_time);
}
kernel void CarpenterKennedy2N54_2b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_3a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_3b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_4a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_4b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_5a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
kernel void CarpenterKennedy2N54_5b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                    global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                    global REAL *d_field_rho, global REAL *time) {
...
ToulorgeDesmet2N84F.
*/
kernel void ToulorgeDesmet2N84F_1a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_1b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_2a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_2b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_3a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_3b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_4a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_4b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_5a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_5b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_6a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_6b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_7a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_7b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_8a(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
...
kernel void ToulorgeDesmet2N84F_8b(global REAL4 *d_field_b1, global REAL4 *d_field_b2,
                                   global REAL4 *d_field_curlB_rho, global REAL4 *d_field_u,
                                   global REAL *d_field_rho, global REAL *time) {
